package com.example.streamline.activity
...
import com.example.streamline.activity.MainActivity.Companion.myPager
import com.example.streamline.activity.MainActivity.Companion.tabsBtn
import com.example.streamline.adapter.TabAdapter
import com.example.streamline.databinding.ActivityMainBinding
import com.example.streamline.databinding.BookmarkDialogBinding
import com.example.streamline.databinding.MoreFeaturesBinding
import com.example.streamline.databinding.TabsViewBinding
import com.example.streamline.fragment.BrowseFragment
import com.example.streamline.fragment.HomeFragment
import com.example.streamline.model.Bookmark
import com.example.streamline.model.Tab
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intializeView()
        changeFullscreen(enable = true) //by default full screen
    }
        ...
        binding.tabsBtn.setOnClickListener{
            ...
            val dialogTabs = MaterialAlertDialogBuilder(this, R.style.roundCornerDialog).setView(viewTabs)
                ...
                .setPositiveButton("Home"){self, _ ->
                    changedTab("Home", HomeFragment())
                    self.dismiss()
                }
                .setNeutralButton("Google"){self, _ ->
                    changedTab("Google", BrowseFragment("www.google.com"))
                    self.dismiss()
                }
                .create()
    ...
    override fun onResume() {
        ...
        printJob?.let {
            when{
                it.isCompleted -> Snackbar.make(binding.root, "Successfull -> ${it.info.label}", 4000).show()
...
@SuppressLint("NotifyDataSetChanged")
fun changedTab(url: String, fragment: Fragment, isBackground:Boolean = false){
