...
import com.example.streamline.databinding.FragmentBrowseBinding
...
class BrowseFragment(private var urlNew: String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.webView.apply {
            when{
                ...
                else -> loadUrl("https://www.google.com/search?q=$urlNew") //default search engine
            }
        }
    ...
    override fun onResume() {
        ...
        binding.webView.apply {
            ...
            webChromeClient = object: WebChromeClient(){
                //for setting icon to search bar
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        ...
        when(item.title){
            "Open in New Tab" -> {
                changedTab(url.toString(), BrowseFragment(url.toString()))
            }
            "Open Tab in Background" -> {
                changedTab(url.toString(), BrowseFragment(url.toString()), isBackground = true)
            }
            ...
            "View Image" ->{
                if(imgUrl != null) {
                    ...
                    else changedTab(imgUrl, BrowseFragment(imgUrl))
                }
            }
